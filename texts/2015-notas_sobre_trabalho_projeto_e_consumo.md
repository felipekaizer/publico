---
title: Notas sobre Trabalho, Projeto e Consumo
year: 2015
lang: pt-BR
order: 1
layout: default
...
1. pela extensão indevida à dimensão subjetiva das nossas preocupações com a produção em escala de *um* objeto a cada vez, como se, ao final, à cada produto correspondesse um usuário.
2. por objetivar a satisfação de todos (que partilhem das mesmas necessidades), sem exceções.
...
1. constatamos que o “denominador comum” que nos permitia generalizar a condição de usuário era o mero potencial para consumir.
2. descobrimos que o distanciar-se do nosso “ponto de fuga” no horizonte corresponde à atividade incessante de consumir, ligada umbilicalmente à manutenção da vida biológica[^5] e à fonte inesgotável dos desejos[^6]. E que, como uma pulsão, o consumo é o fator que “puxa” todo o ciclo produtivo[^7] e consequentemente todos os projetos que se desenvolvem no seu interior.
...
1. o designer pode ocupar uma posição dentro de uma empresa pública ou privada que oferece produtos ou serviços. Nesse caso ele se subordina à direção da empresa que estabelece que relações devem ser mantidas com os usuários ou consumidores.
2. o designer pode oferecer seus projetos ao mercado de empresas. Nesse caso sua relação com usuários ou consumidores é intermediada pela direção de alguma dessas empresas, que detém o poder para, entre outras coisas, engavetar seus projetos.
3. o designer pode oferecer seus projetos ao mercado através da própria empresa. Nesse caso ele dirige a empresa e pode (agora sim) trabalhar diretamente para os seus usuários ou consumidores, empregando potencialmente outros designers.
...
1. em função da sua práxis, os designers (tais como outros projetistas), desenvolvem uma *visão sistêmica* das situações de projeto, o que lhes permite analisar e intervir nos problemas complexos típicos das economias de escala.
2. a visão sistêmica se alia a um domínio das práticas de projeto, que permite agir sobre as condições atuais com o intuito de provocar mudanças deliberadas. Dito de outro modo, os projetistas em geral trabalham na construção de novos cenários. Isso os retira potencialmente da condição de instrumentos para dotá-los do caráter de agentes.
3. além de uma visão sistêmica e projetiva, os designers se vêem como algo a mais que um ajuntamento de indivíduos; pela natureza do seu trabalho eles se entendem como grupo, com potencial para ações coordenadas. Essa visão, que se faz necessária para garantir a eficiência dos projetos desenvolvidos em equipe, os coloca obrigatoriamente em articulação uns com os outros e com os demais profissionais e gera um potencial de auto-organização capaz de gerar um ciclo de externalidades positivas[^15] que beneficiam a todos.
...
[^1]: O Capital (Livro I) – Karl Marx
[^2]: Design: como Prática de Projeto – Gui Bonsiepe
[^3]: Contribuição à crítica da economia política – Karl Marx
[^4]: [Story of Stuff Project]
[^5]: A Condição Humana – Hannah Arendt
[^6]: The Century of the Self (BBC)
[^7]: TED Talks – Nick Hanauer
[^8]: Contribuição à crítica da economia política – Karl Marx
[^9]: O capital (Livro I) – Karl Marx
[^10]: Contribuição à crítica da economia política – Karl Marx
[^11]: Pyramids of Waste – Cosima Dannoritzer
[^12]: This Changes Everything – Naomi Klein
[^13]: Design, Cultura e Sociedade – Gui Bonsiepe
[^14]: Global Capitalism: Monthly Update – Richard D. Wollf
[^15]: O imaterial – André Gorz
[^16]: Objetos de desejo – Adrian Forty

[Vernaculando]: http://vernaculando.vermelhopanda.com/2015/11/03/felipe-kaizer/
