---
title: 'Uma proposta de base de dados sobre o Centro Universitário Maria Antonia: Projeto'
year: 2013
lang: pt-BR
layout: default
...
Documento iniciado em 2013-01-20; concluído em 2013-04-02; revisado em 2013-05-09.

[![Creative Commons License](http://i.creativecommons.org/l/by-nc-nd/3.0/80x15.png)](http://creativecommons.org/licenses/by-nc-nd/3.0/deed.en_US) Uma proposta de base de dados sobre o Centro Universitário Maria Antonia by Felipe Kaizer is licensed under a [Creative Commons Attribution-NonCommercial-NoDerivs 3.0 Unported License](http://creativecommons.org/licenses/by-nc-nd/3.0/deed.en_US).
...
Por fim, adianto ao leitor que na [primeira parte](#parte-1) deste trabalho trato com brevidade das questões que se colocam de imediato em uma proposta de base de dados, a saber, 1. em que medida ela faz jus aos interesses que a animam, e 2. se ela se caracteriza como um projeto de design em meio a uma série de disciplinas correlatas, como a ciência da informação e a arquivística. Na [segunda parte](#parte-2) descrevo todos os itens e relações do modelo de base de dados proposta com a granularidade adequada a um estudo e não a sua implementação. Na [terceira parte](#parte-3) apresento minhas impressões finais sobre a proposta, confesso minhas expectativas quanto ao seu futuro e agradeço a todos que envolvi neste projeto. [Anexo](#anexos) também algumas correspondências que julguei relevantes a esta documentação.
...
| :-------- | :---------- | :-------------------------------------------------- |
| acervo    | ac          | localização física ou virtual das fontes            |
| etiquetas | et          | palavras e expressões aplicadas às fontes           |
| coleções  | cl          | agrupamentos de fontes por origem ou interesse      |
| fontes    | ft          | fontes de informação sobre o assunto                |
| graus     | gr          | graus de relevância atribuídos às fontes            |
| línguas   | lg          | línguas utilizadas pelas fontes                     |
| pessoas   | ps          | pessoas físicas ou jurídicas relacionadas às fontes |

#### Subitens

| item               | subitem                                                      | descrição                                           |
| :----------------- | :----------------------------------------------------------- | :-------------------------------------------------- |
| ac                 | acervo                                                       | endereço físico ou digital das fontes               |
| et                 | etiquetas                                                    | palavras e expressões aplicadas às fontes           |
| cl                 | coleções                                                     | agrupamentos de fontes por origem ou interesse      |
| ft                 |                                                              |                                                     |
...
| gr                 | graus                                                        | graus de relevância atribuídos às fontes            |
| lg                 | línguas                                                      | línguas utilizadas pelas fontes                     |
| ps                 | pessoas                                                      | pessoas, empresas ou instituições ligadas às fontes |

#### Classes

| subitem            | classe                                | descrição                                         |
| :----------------- | :------------------------------------ | :------------------------------------------------ |
| acervo             | ac_acervo                             | coordenadas dos endereços                         |
| ac_digital         | coordenadas dos endereços digitais    |                                                   |
| ac_fisico          | coordenadas do endereços físicos      |                                                   |
| etiquetas          | et_etiqueta                           | palavras e expressões                             |
| coleções           | cl_colecao                            | agrupamentos                                      |
| áudios             | ft_audio                              | gravações                                         |
| ft_audio_part      | participações nas gravações           |                                                   |
| documentos         | ft_doc                                | documentos                                        |
| ft_doc_part        | participações nos documentos          |                                                   |
| ft_doc_tipo        | tipos de documentos                   |                                                   |
| edições            | ft_edicao                             | publicações                                       |
| ft_edicao_part     | participações nas publicações         |                                                   |
| eventos            | ft_evento                             | eventos                                           |
| ft_evento_local    | locais dos eventos                    |                                                   |
| ft_evento_part     | participações nos eventos             |                                                   |
| ft_evento_tipo     | tipos de eventos                      |                                                   |
| imagens            | ft_imagem                             | imagens e fotografias                             |
| ft_imagem_part     | participações nas imagens             |                                                   |
| matérias           | ft_materia                            | artigos e notas de periódicos                     |
| ft_materia_part    | participações nas matérias            |                                                   |
| materiais gráficos | ft_mgraf                              | materiais gráficos                                |
| ft_mgraf_part      | participações nos materiais gráficos  |                                                   |
| ft_mgraf_tipo      | tipos de materiais gráficos           |                                                   |
| plantas            | ft_planta                             | plantas e elevações dos edifícios                 |
| ft_planta_part     | participações nas plantas e elevações |                                                   |
| sites              | ft_site                               | websites, portais e blogs                         |
| textos             | ft_texto                              | textos, monografias, correspondências e processos |
| ft_texto_part      | participações nos textos              |                                                   |
| ft_texto_tipo      | tipos de textos                       |                                                   |
| vídeos             | ft_video                              | vídeos e filmes                                   |
| ft_video_part      | participações nos vídeos              |                                                   |
| graus              | gr_grau                               | graus de relevância                               |
| línguas            | lg_lingua                             | línguas                                           |
| pessoas            | ps_part_tipo                          | tipos de participações                            |
| ps_pessoa          | pessoas, empresas ou instituições     |                                                   |
| ps_fisica          | pessoas                               |                                                   |
| ps_juridica        | empresas ou instituições              |                                                   |

#### Atributos

| classe          | atributo                         | descrição                                                    |
| :-------------- | :------------------------------- | :----------------------------------------------------------- |
| ac_digital      | endereco                         | URL                                                          |
| codigo          | URN                              |                                                              |
| ac_fisico       | endereco                         | localização por extenso                                      |
| codigo          | código identificador             |                                                              |
| et_etiqueta     | etiqueta                         | vocábulo ou expressão                                        |
| cl_colecao      | nome                             | nome                                                         |
| inicio          | data de início                   |                                                              |
| descricao       | descrição                        |                                                              |
| ft_audio        | titulo                           | título                                                       |
| duracao         | duração                          |                                                              |
| descricao       | descrição                        |                                                              |
| ft_audio_part   | audio                            | gravações                                                    |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_doc          | titulo                           | título                                                       |
| subtitulo       | subtítulo                        |                                                              |
| ano             | ano de conclusão                 |                                                              |
| descricao       | descrição                        |                                                              |
| ft_doc_part     | doc                              | documentos                                                   |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_doc_tipo     | tipo                             | nome do tipo                                                 |
| ft_edicao       | titulo                           | título                                                       |
| subtitulo       | subtítulo                        |                                                              |
| ano             | ano da edição                    |                                                              |
| numero          | número da edição                 |                                                              |
| isbn            | ISBN mais atual                  |                                                              |
| resumo          | texto da contracapa ou orelha    |                                                              |
| ft_edicao_part  | edicao                           | livros, catálogos e outras publicações                       |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_evento       | nome                             | nome                                                         |
| inicio          | data de início                   |                                                              |
...
| descricao       | descrição                        |                                                              |
| ft_evento_local | nome                             | nome                                                         |
| endereco        | endereço                         |                                                              |
| cep             | CEP                              |                                                              |
| ft_evento_part  | evento                           | eventos                                                      |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_evento_tipo  | tipo                             | nome do tipo                                                 |
| ft_imagem       | titulo                           | título                                                       |
| ano             | ano                              |                                                              |
| descricao       | descrição ou legenda             |                                                              |
| ft_imagem_part  | imagem                           | imagens e fotografias                                        |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_materia      | titulo                           | título                                                       |
| subtitulo       | subtítulo, intertítulo ou resumo |                                                              |
| data            | data de publicação               |                                                              |
| secao           | seção do periódico               |                                                              |
| ano             | ano do periódico                 |                                                              |
| numero          | número do periódico              |                                                              |
| pagina          | página inicial                   |                                                              |
| ft_materia_part | materia                          | artigos e notas de periódicos                                |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_mgraf        | titulo                           | título                                                       |
| ft_mgraf_part   | mgraf                            | materiais gráficos                                           |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_mgraf_tipo   | tipo                             | nome do tipo                                                 |
| ft_planta       | projeto                          | nome do projeto ou edifício                                  |
| conteudo        | conteúdo da prancha              |                                                              |
| data            | data inicial                     |                                                              |
| data_rev        | data da última revisão           |                                                              |
| ft_planta_part  | planta                           | plantas e elevações dos edifícios                            |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_site         | url                              | URL completa                                                 |
| ft_texto        | titulo                           | título                                                       |
| subtitulo       | subtítulo                        |                                                              |
| ano             | ano                              |                                                              |
| descricao       | descrição                        |                                                              |
| ft_texto_part   | texto                            | textos e monografias                                         |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| ft_texto_tipo   | tipo                             | nome do tipo                                                 |
| ft_video        | titulo                           | título                                                       |
| ano             | ano                              |                                                              |
| descricao       | descrição                        |                                                              |
| ft_video_part   | video                            | vídeos e filmes                                              |
| tipo            | tipos de participações           |                                                              |
| pessoa          | pessoas que participam           |                                                              |
| gr_grau         | grau                             | grau                                                         |
| relevancia      | descrição da relevância          |                                                              |
| assunto         | assunto                          |                                                              |
| conteudo        | conteúdo                         |                                                              |
| origem          | origem                           |                                                              |
| lg_lingua       | iso                              | código ISO 639-1                                             |
| lingua          | língua                           |                                                              |
| ps_part_tipo    | tipo                             | tipos de participações                                       |
| ps_fisica       | ass                              | assinatura, pseudônimo, apelido ou nome artístico ou de guerra |
| nome            | nome completo                    |                                                              |
| url             | um endereço de site de internet  |                                                              |
| endereco        | um endereço completo com CEP     |                                                              |
| nasc            | data de nascimento completa      |                                                              |
| falc            | data de falecimento completa     |                                                              |
| atuacao         | atuações profissionais           |                                                              |
| bio             | biografia curta                  |                                                              |
| ps_juridica     | nome                             | nome fantasia                                                |
| sigla           | sigla                            |                                                              |
| razao           | razão social                     |                                                              |
| atividade       | atividades que exerce            |                                                              |
| url             | um endereço de site de internet  |                                                              |
| endereco        | um endereço completo com CEP     |                                                              |
...
| item   | relação              | item      |
| :----- | :------------------- | :-------- |
| fontes | presentes em         | acervo    |
| fontes | marcadas por         | etiquetas |
| fontes | agrupadas em         | coleções  |
| fontes | relacionadas a       | fontes    |
| fontes | classificadas em     | graus     |
| fontes | em                   | línguas   |
| fontes | com participações de | pessoas   |

##### Relações entre subitens

| item | subitem            | relação               | subitem    | item |
| :--- | :----------------- | :-------------------- | :--------- | :--- |
| ft   | áudios             | presentes em          | acervo     | ac   |
| ft   | áudios             | marcados por          | etiquetas  | et   |
| ft   | áudios             | agrupados em          | coleções   | cl   |
| ft   | áudios             | de                    | eventos    | ft   |
| ft   | áudios             | classificados em      | graus      | gr   |
| ft   | áudios             | em                    | línguas    | lg   |
| ft   | áudios             | com participações de  | pessoas    | ps   |
| ft   | documentos         | presentes em          | acervo     | ac   |
| ft   | documentos         | marcados por          | etiquetas  | et   |
| ft   | documentos         | agrupados em          | coleções   | cl   |
| ft   | documentos         | de                    | eventos    | ft   |
| ft   | documentos         | que contêm            | imagens    | ft   |
| ft   | documentos         | que contêm            | plantas    | ft   |
| ft   | documentos         | que contêm            | textos     | ft   |
| ft   | documentos         | classificados em      | graus      | gr   |
| ft   | documentos         | em                    | línguas    | lg   |
| ft   | documentos         | com participações de  | pessoas    | ps   |
| ft   | edições            | presentes em          | acervo     | ac   |
| ft   | edições            | marcadas por          | etiquetas  | et   |
| ft   | edições            | agrupadas em          | coleções   | cl   |
| ft   | edições            | que contêm            | documentos | ft   |
| ft   | edições            | sobre                 | eventos    | ft   |
| ft   | edições            | que contêm            | imagens    | ft   |
| ft   | edições            | que contêm            | textos     | ft   |
| ft   | edições            | classificadas em      | graus      | gr   |
| ft   | edições            | em                    | línguas    | lg   |
| ft   | edições            | com participações de  | pessoas    | ps   |
| ft   | eventos            | marcados por          | etiquetas  | et   |
| ft   | eventos            | relacionados a outros | eventos    | ft   |
| ft   | eventos            | com participação de   | pessoas    | ps   |
| ft   | imagens            | presentes em          | acervo     | ac   |
| ft   | imagens            | marcadas por          | etiquetas  | et   |
| ft   | imagens            | agrupadas em          | coleções   | cl   |
| ft   | imagens            | de                    | eventos    | ft   |
| ft   | imagens            | classificadas em      | graus      | gr   |
| ft   | imagens            | com participações de  | pessoas    | ps   |
| ft   | matérias           | presentes em          | acervo     | ac   |
| ft   | matérias           | marcadas por          | etiquetas  | et   |
| ft   | matérias           | agrupadas em          | coleções   | cl   |
| ft   | matérias           | sobre                 | eventos    | ft   |
| ft   | matérias           | que contêm            | imagens    | ft   |
| ft   | matérias           | que contêm            | textos     | ft   |
| ft   | matérias           | que contêm            | videos     | ft   |
| ft   | matérias           | classificadas em      | graus      | gr   |
| ft   | matérias           | em                    | línguas    | lg   |
| ft   | matérias           | com participações de  | pessoas    | ps   |
| ft   | materiais gráficos | presentes em          | acervo     | ac   |
| ft   | materiais gráficos | marcados por          | etiquetas  | et   |
| ft   | materiais gráficos | agrupados em          | coleções   | cl   |
| ft   | materiais gráficos | de                    | eventos    | ft   |
| ft   | materiais gráficos | que contêm            | imagens    | ft   |
| ft   | materiais gráficos | que contêm            | textos     | ft   |
| ft   | materiais gráficos | classificados em      | graus      | gr   |
| ft   | materiais gráficos | em                    | línguas    | lg   |
| ft   | plantas            | presentes em          | acervo     | ac   |
| ft   | plantas            | marcadas por          | etiquetas  | et   |
| ft   | plantas            | agrupadas em          | coleções   | cl   |
| ft   | plantas            | classificadas em      | graus      | gr   |
| ft   | plantas            | com participações de  | pessoas    | ps   |
| ft   | sites              | marcados por          | etiquetas  | et   |
| ft   | sites              | agrupados em          | coleções   | cl   |
| ft   | sites              | de                    | eventos    | ft   |
| ft   | sites              | classificados em      | graus      | gr   |
| ft   | sites              | em                    | línguas    | lg   |
| ft   | textos             | presentes em          | acervo     | ac   |
| ft   | textos             | marcados por          | etiquetas  | et   |
| ft   | textos             | agrupados em          | coleções   | cl   |
| ft   | textos             | classificados em      | graus      | gr   |
| ft   | textos             | em                    | línguas    | lg   |
| ft   | textos             | com participações de  | pessoas    | ps   |
| ft   | vídeos             | presentes em          | acervo     | ac   |
| ft   | vídeos             | marcados por          | etiquetas  | et   |
| ft   | vídeos             | agrupados em          | coleções   | cl   |
| ft   | vídeos             | de                    | eventos    | ft   |
| ft   | vídeos             | classificados em      | graus      | gr   |
| ft   | vídeos             | com participações de  | pessoas    | ps   |

##### Relações entre super e subclasses

| classe    | relação                   | classe      |
| :-------- | :------------------------ | :---------- |
| ac_acervo | é superclasse abstrata de | ac_digital  |
| ac_acervo | é superclasse abstrata de | ac_fisico   |
| ps_pessoa | é superclasse abstrata de | ps_fisica   |
| ps_pessoa | é superclasse abstrata de | ps_juridica |

##### Relações entre classes

| classe          | cardinalidade | relação               | cardinalidade | classe          |
| :-------------- | :------------ | :-------------------- | :------------ | :-------------- |
| ft_audio        | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_audio        | 0:n           | marcados por          | 0:n           | et_etiqueta     |
| ft_audio        | 0:n           | agrupados em          | 0:n           | cl_colecao      |
| ft_audio        | 1:1           | com participações de  | 0:n           | ft_audio_part   |
| ft_audio        | 0:n           | de                    | 0:1           | ft_evento       |
| ft_audio        | 0:n           | classificados em      | 1:1           | gr_grau         |
| ft_audio        | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_audio_part   | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_audio_part   | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_doc          | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_doc          | 0:n           | marcados por          | 0:n           | et_etiquetas    |
| ft_doc          | 0:n           | agrupados em          | 0:n           | cl_colecao      |
| ft_doc          | 1:1           | com participações de  | 0:n           | ft_doc_part     |
| ft_doc          | 0:n           | do tipo               | 1:n           | ft_doc_tipo     |
| ft_doc          | 0:n           | sobre                 | 0:1           | ft_evento       |
| ft_doc          | 0:n           | que contêm            | 0:n           | ft_imagem       |
| ft_doc          | 0:n           | que contêm            | 0:n           | ft_planta       |
| ft_doc          | 0:n           | que contêm            | 0:n           | ft_texto        |
| ft_doc          | 0:n           | classificados em      | 1:1           | gr_grau         |
| ft_doc          | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_doc_part     | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_doc_part     | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_edicao       | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_edicao       | 0:n           | marcadas por          | 0:n           | et_etiquetas    |
| ft_edicao       | 0:n           | agrupadas em          | 0:n           | cl_colecao      |
| ft_edicao       | 0:n           | que contêm            | 0:n           | ft_doc          |
| ft_edicao       | 1:1           | com participações de  | 0:n           | ft_edicao_part  |
| ft_edicao       | 0:n           | sobre                 | 0:1           | ft_evento       |
| ft_edicao       | 0:n           | que contêm            | 0:n           | ft_imagem       |
| ft_edicao       | 0:n           | que contêm            | 0:n           | ft_texto        |
| ft_edicao       | 0:n           | classificadas em      | 1:1           | gr_grau         |
| ft_edicao       | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_edicao_part  | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_edicao_part  | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_evento       | 0:n           | marcados por          | 0:n           | et_etiqueta     |
| ft_evento       | 0:n           | relacionados a outros | 0:n           | ft_evento       |
| ft_evento       | 0:n           | ocorrido em           | 0:n           | ft_evento_local |
| ft_evento       | 1:1           | com participações de  | 0:n           | ft_evento_part  |
| ft_evento       | 0:n           | do tipo               | 1:n           | ft_evento_tipo  |
| ft_evento_part  | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_evento_part  | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_imagem       | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_imagem       | 0:n           | marcadas por          | 0:n           | et_etiqueta     |
| ft_imagem       | 0:n           | agrupadas em          | 0:n           | cl_colecao      |
| ft_imagem       | 0:n           | de                    | 0:1           | ft_evento       |
| ft_imagem       | 1:1           | com participações de  | 0:n           | ft_imagem_part  |
| ft_imagem       | 0:n           | classificadas em      | 1:1           | gr_grau         |
| ft_imagem_part  | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_imagem_part  | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_materia      | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_materia      | 0:n           | marcados por          | 0:n           | et_etiqueta     |
| ft_materia      | 0:n           | agrupados em          | 0:n           | cl_colecao      |
| ft_materia      | 0:n           | sobre                 | 0:1           | ft_evento       |
| ft_materia      | 0:n           | que contêm            | 0:n           | ft_imagem       |
| ft_materia      | 0:n           | que contêm            | 0:n           | ft_texto        |
| ft_materia      | 0:n           | que contêm            | 0:n           | ft_video        |
| ft_materia      | 1:1           | com participações de  | 0:n           | ft_materia_part |
| ft_materia      | 0:n           | classificados em      | 1:1           | gr_grau         |
| ft_materia      | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_materia_part | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_materia_part | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_mgraf        | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_mgraf        | 0:n           | marcados por          | 0:n           | et_etiqueta     |
| ft_mgraf        | 0:n           | de                    | 0:1           | ft_eventos      |
| ft_mgraf        | 0:n           | que contêm            | 0:n           | ft_imagem       |
| ft_mgraf        | 0:n           | que contêm            | 0:n           | ft_texto        |
| ft_mgraf        | 1:1           | com participações de  | 0:n           | ft_mgraf_part   |
| ft_mgraf        | 0:n           | do tipo               | 1:1           | ft_mgraf_tipo   |
| ft_mgraf        | 0:n           | classificados em      | 1:1           | gr_grau         |
| ft_mgraf        | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_mgraf_part   | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_mgraf_part   | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_planta       | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_planta       | 0:n           | marcadas por          | 0:n           | et_etiqueta     |
| ft_planta       | 0:n           | agrupadas em          | 0:n           | cl_colecao      |
| ft_planta       | 1:1           | com participações de  | 0:n           | ft_planta_part  |
| ft_planta       | 0:n           | classificadas em      | 1:1           | gr_grau         |
| ft_planta_part  | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_planta_part  | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_site         | 0:n           | marcados com          | 0:n           | et_etiqueta     |
| ft_site         | 0:n           | agrupados em          | 0:n           | cl_colecao      |
| ft_site         | 0:n           | de                    | 0:1           | ft_evento       |
| ft_site         | 0:n           | classificados em      | 1:1           | gr_grau         |
| ft_site         | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_texto        | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_texto        | 0:n           | marcados por          | 0:n           | et_etiqueta     |
| ft_texto        | 0:n           | agrupados em          | 0:n           | cl_colecao      |
| ft_texto        | 1:1           | em                    | 0:n           | ft_texto_part   |
| ft_texto        | 0:n           | do tipo               | 1:n           | ft_texto_tipo   |
| ft_texto        | 0:n           | classificados em      | 1:1           | gr_grau         |
| ft_texto        | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_texto_part   | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_texto_part   | 0:n           | com participações de  | 1:1           | ps_pessoa       |
| ft_video        | 1:1           | presentes em          | 0:n           | ac_acervo       |
| ft_video        | 0:n           | marcados por          | 0:n           | et_etiqueta     |
| ft_video        | 0:n           | agrupados em          | 0:n           | cl_colecao      |
| ft_video        | 0:n           | de                    | 0:1           | ft_evento       |
| ft_video        | 1:1           | com participações de  | 0:n           | ft_video_part   |
| ft_video        | 0:n           | classificados em      | 1:1           | gr_grau         |
| ft_video        | 0:n           | em                    | 1:n           | lg_lingua       |
| ft_video_part   | 0:n           | com participações de  | 1:1           | ps_part_tipo    |
| ft_video_part   | 0:n           | com participações de  | 1:1           | ps_pessoa       |

### Exemplo

Nesse exemplo, para tornar mais explícita as relações entre dados, simulei as características da linguagem MySQL, convertendo as classes em tabelas e os atributos em campos. Do mesmo modo, transformei as heranças entre sub e superclasses em relações entre tabelas com cardinalidade 0:n-1:n, substitui relações ?:n-?:n por tabelas intermediárias e acrescentei quando necessário campos de chaves integrais únicas que não constam no modelo de dados original, indicando as chaves estrangeiras entre parênteses.
...
| ---------------------------------------- | ----------------------- |
| endereco                                 | codigo                  |
| file:///users/mariantonia/mabd/projeto/  | a_alma_dos_edificos.pdf |
| http://www.felipekaizer.com/mabd/images/ | a_alma_dos_edificos.pdf |
| sala 1 - estante A - caixa A001          | i0001                   |
...
| cl_colecao    |                 |        |                                                              |
| ------------- | --------------- | ------ | ------------------------------------------------------------ |
| id_cl_colecao | nome            | inicio | descricao                                                    |
| 01            | Para iniciantes |        | Fontes de informação para aqueles que estão iniciando suas pesquisas |
...
| ft_edicao    |                      |           |      |        |            |        |
| ------------ | -------------------- | --------- | ---- | ------ | ---------- | ------ |
| id_ft_edicao | titulo               | subtitulo | ano  | numero | isbn       | resumo |
| 01           | A alma dos edifícios |           | 2004 | 1      | 8588849305 | […]    |

| ft_edicao_ac_acervo   |                                          |                   |
| --------------------- | ---------------------------------------- | ----------------- |
| edicao (id_ft_edicao) | endereco (endereco)                      | codigo (codigo)   |
| 01                    | file:///users/mariantonia/mabd/projeto/  | alma_edificos.pdf |
| 01                    | http://www.felipekaizer.com/mabd/images/ | alma_edificos.pdf |
| 01                    | sala 1 - estante A - caixa A001          | i0001             |

| ft_edicao_cl_colecao  |                         |
| --------------------- | ----------------------- |
| edicao (id_ft_edicao) | colecao (id_cl_colecao) |
| 01                    | 01                      |

| ft_edicao_et_etiqueta |                     |
| --------------------- | ------------------- |
| edicao (id_ft_edicao) | etiqueta (etiqueta) |
| 01                    | arquitetura         |
| 01                    | arte                |

| ft_edicao_gr_grau     |             |
| --------------------- | ----------- |
| edicao (id_ft_edicao) | grau (grau) |
| 01                    | 5           |

| ft_edicao_lg_lingua   |              |
| --------------------- | ------------ |
| edicao (id_ft_edicao) | lingua (iso) |
| 01                    | pt           |
| 01                    | en           |
| 01                    | de           |
...
| ft_edicao_part        |                        |                       |
| --------------------- | ---------------------- | --------------------- |
| edicao (id_ft_edicao) | tipo (id_ps_part_tipo) | pessoa (id_ps_pessoa) |
| 01                    | 01                     | 01                    |
| 01                    | 01                     | 03                    |
| 01                    | 01                     | 05                    |
| 01                    | 01                     | 07                    |
...
| ft_evento    |                                |            |            |           |
| ------------ | ------------------------------ | ---------- | ---------- | --------- |
| id_ft_evento | nome                           | inicio     | termino    | descricao |
| 01           | MemoriAntonia                  | 18/09/2003 | 19/10/2003 |           |
| 02           | São Paulo, Cidade sem Memória? | 11/09/2001 |            |           |

| ft_evento_cl_colecao  |                         |
| --------------------- | ----------------------- |
| evento (id_ft_evento) | colecao (id_cl_colecao) |
| 01                    | 01                      |

| ft_evento_et_etiqueta |                     |
| --------------------- | ------------------- |
| evento (id_ft_evento) | etiqueta (etiqueta) |
| 01                    | arquitetura         |
| 01                    | arte                |
| 02                    | arquitetura         |
| 02                    | arte                |
...
| ft_evento_ft_evento   |                       |
| --------------------- | --------------------- |
| evento (id_ft_evento) | evento (id_ft_evento) |
| 01                    | 02                    |

| ft_evento_gr_grau     |             |
| --------------------- | ----------- |
| evento (id_ft_evento) | grau (grau) |
| 01                    | 5           |
| 02                    | 5           |

| ft_edicao_lg_lingua   |              |
| --------------------- | ------------ |
| evento (id_ft_evento) | lingua (iso) |
| 01                    | pt           |
| 02                    | pt           |

| ft_evento_local    |                                    |                                                           |           |
| ------------------ | ---------------------------------- | --------------------------------------------------------- | --------- |
| id_ft_evento_local | nome                               | endereco                                                  | cep       |
| 01                 | Centro Universitário Maria Antonia | Rua Maria Antonia, 258 e 294, Vila Buarque, São Paulo, SP | 01222-010 |
| 02                 | Goethe-Institut São Paulo          | Rua Lisboa, 974, São Paulo, SP                            | 05413-001 |

| ft_evento_part        |                        |        |
| --------------------- | ---------------------- | ------ |
| evento (id_ft_evento) | tipo (id_ps_part_tipo) | pessoa |
| 01                    | 08                     | 07     |
| 01                    | 08                     | 05     |
| 01                    | 09                     | 13     |
| 01                    | 09                     | 15     |
...
| ft_evento_tipo    |           |
| ----------------- | --------- |
| id_ft_evento_tipo | tipo      |
| 01                | exposição |
| 02                | workshop  |

| gr_grau |                 |          |                |        |
| ------- | --------------- | -------- | -------------- | ------ |
| grau    | relevancia      | assunto  | conteudo       | origem |
| 5       | muito relevante | o Centro | sobre o Centro | Centro |
...
| ps_fisica                   |                          |
| --------------------------- | ------------------------ |
| id_ps_fisica (id_ps_pessoa) | ass                      |
| 01                          | Horacio González         |
| 03                          | Ivo Mesquita             |
| 05                          | Joachim Bernauer         |
| 07                          | Lorenzo Mammì            |
| 09                          | Márcio Seligmann-Silva   |
| 11                          | Horst Hoheisel           |
| 13                          | Fulvia Molina            |
| 15                          | Marcelo Brodsky          |
| 17                          | Andreas Knitz            |
| 19                          | Aaron Myers              |
| 21                          | Alfredo Keller           |
| 23                          | Clarice de Figueiredo    |
| 25                          | Luciana Carvalho         |
| 27                          | Sabrina Molina           |
| 29                          | Tanja Hoheisel           |
| 31                          | Jeanette Harding         |
| 33                          | Alessandro Camilo Miguel |
| 35                          | Dália Rosenthal          |
| 37                          | Marcelo Berg             |
| 39                          | Taísa Helena P. Palhares |
| 41                          | Luise Weiss              |
| 43                          | Hugo Fortes              |
| 45                          | Caio Reisewitz           |
| 47                          | André Luiz Yassuda       |
| 49                          | Juliana Monteiro         |
| 51                          | Danilo Volpato           |
| 53                          | Liliane Benetti          |
| 55                          | Síssi Fonseca            |
...
| ps_juridica                   |                                            |
| ----------------------------- | ------------------------------------------ |
| id_ps_juridica (id_ps_pessoa) | nome                                       |
| 02                            | Centro Universitário Maria Antonia         |
| 04                            | Daimler Chrysler                           |
| 06                            | Universidade de São Paulo                  |
| 08                            | Embaixada da República Federal da Alemanha |
| 10                            | Câmara dos Deputados                       |
| 12                            | Goethe-Institut São Paulo                  |
| 14                            | Imprensa Oficial                           |
...
* **Cross**, Nigel. “Editorial Forty years of design research”. In: *Design Studies Vol. 28*. Elsevier, 2007.
* **Date**, C. J. *Database Design and Relational Theory: Normal Forms and All That Jazz*. Sebastopol: O'Reilly, 2012.
* ***Dicionário brasileiro de terminologia arquivística***. Rio de Janeiro: Arquivo Nacional, 2005
* *O **Espaço da USP**: presente e futuro*. Universidade de São Paulo, Prefeitura da Cidade Universitária “Armando de Salles Oliveira”. São Paulo: A Prefeitura, 1985.
* **Gaspari**, Elio. *A ditadura envergonhada*. São Paulo: Compainha das Letras, 2002.
* **Hoheisel**, Horst *et. al*. *A Alma dos edifícios = Die Seeler der Gebaude = The soul of the buildings*. Vários tradutores. São Paulo: Centro Universitário Maria Antonia (USP), 2004.
* **Matos**, Olgaria C. F. *Paris 1968: as barricadas do desejo*. 3. ed. São Paulo: Editora Brasiliense, 1989. (Tudo é história; 9)
* **Medeiros**, Luciano Frontino de. *Banco de dados: princípios e prática*. Curitiba: Ibpex, 2007.
* **Miller**, William. *A definição de design*. Trad. João de Souza Leite do original de “The definition of Design” (1988). Não publicado.
* **Rittel**, Horst & **Webber**, Melvin. “Dilemmas in a General Theory of Planning”. In: *Policy Sciences 4*. Amsterdã: Elsevier, 1973.
* **Russo**, Mariza. *Fundamentos em biblioteconomia e ciência da informação*. Rio de Janeiro: E-papers serviços editorias, 2012. (Coleção Biblioteconomia e Gestão de Unidades de Informação. Série didáticos, n. 1).
* **Sartre**, Jean-Paul & **Cohn-Bendit**, Daniel. “A expansão do campo do possível”. In: *Maio de 68*. Rio de Janeiro: Beco do Azougue, 2008.
* **Simon**, Herbert. *The sciences of the artficial*. 3. ed. Cambridge: The MIT Press, 2006.
* **Swartz**, Aaron. *Who Runs Wikipedia?*. Disponível em <[www.aaronsw.com/weblog/whorunswikipedia](http://www.aaronsw.com/weblog/whorunswikipedia)>. Acessado em 16 mar. 2013

### Agradecimentos

Agradeço, em primeiro lugar, aos meus orientadores Maria Argentina Bibas e Minoru Naruto pela confiança e atenção dispensadas. Em segundo lugar, a Tuca Capelossi, Rodrigo Vazquez e Thiara Grizilli pelas horas de atenção. Em especial aos amigos Victor Bergmann e [Gustavo Ferreira](http://hipertipo.com/), cujo profissionalismo e *expertise* foram indispensáveis. A Maíra Lioi por [recordar de Aaron Swartz (1986-2013)](http://www.rememberaaronsw.com/). Às amigas Ana Sartori, Aninha de Carvalho e Luiza Crosman pelo apoio incondicional. Por fim, a Alícia Toffani pela revisão impecável do texto.

***

## Anexos

### 1 ago. 2012: Mensagem aos coordenadores do curso
{: #anexo-1 }
...
1. **Uma intervenção direta e pontual num edifícios do CEUMA.** Essa foi de fato a primeira ideia, no dia em que comecei a pensar sobre o projeto. Naquele mês lembro das manifestações contra a comemoração do golpe de 64 na Cinelândia, e uma imagem virou para mim uma referência: Vladimir Herzog projetado sobre a fachada do Clube Militar: <http://desarquivandobr.files.wordpress.com/2012/04/herzogprojetadonoclubemilitar.jpg>
2. **Um mapa mental das pesquisas, referências e anotações compiladas pessoalmente sobre a Guerra do Maria Antônia.** Assim que eu comecei a pesquisar sobre o assunto, pensei num formato (possivelmente um cartaz informativo, de uma face) onde pudesse organizar através de mapas, listas e esquemas tudo aquilo que, pessoalmente, descobri sobre a guerra. De forma alguma o trabalho teria a pretensão de ser exaustivo – por isso o componente pessoal é tão importante. Eu imprimiria alguma cópias.
3. **Uma linha do tempo da história dos edifícios do CEUMA (ex-Filosofia USP).** Esse seria um dos produtos mais óbvios e úteis ao próprio Centro. Tuca me mostrou parte das informações que ela já tinha levantando, e sobre a importância dos documentos para o processo de tombamento do edifício (que se não me engano está em andamento). Novamente algo no formato de um cartaz poderia ser bom.
4. **Um ensaio com as fotos da Guerra.** Encontrei algumas imagens na pasta que não tinham sido publicadas (ou eram pouco conhecidas). Um projeto desse tipo poderia ser um exercício de narrativa visual, sem texto. Eu poderia pedir um opinião do Musa eventualmente.
5. **Uma organização do conteúdo já existente e já possuído pelo Centro.** Esse seria um projeto fundamentalmente não-visual, motivado sobretudo pela preciosidade das informações, o estado de precariedade de algumas delas, e o desejo de tornar o acesso, a pesquisa e a consulta dos interessados mais fácil. Imagino o projeto de um banco de dados que indicie potencialmente toda informação relativa a Guerra da Maria Antônia.
...
### 14 out. 2012: Mensagem aos coordenadores do curso
{: #anexo-2 }
...
1. Com os interessados posso validar as etapas do projeto de base de dados, mesmo que se trate, ao final, apenas de um estudo.
2. Posso me aproveitar das pesquisas que eles já tem em andamento, sobre tipos de materiais, critérios de classificação, volume de dados para testes, etc.
3. Eles podem me ajudar com testes simples da base de dados, sobretudo com buscas.
4. Com a existência desse Centro, vislumbro também, num futuro próximo, a chance de dar alguma concretude a essa ferramenta.
...
### 24 out. 2012: Primeira redação da proposta
{: #anexo-3 }
...
### 23 nov. 2012: Mensagem ao Centro de Documentação e Memória
...
* todos estão potencialmente associados a pessoas, instituições ou empresas
* todos estão potencialmente associados a palavras-chave
* todos eles tem graus de relevância

Como conversamos os graus de relevância são definidos pela proximidade com o assunto:

* 1º referência primária – sobre o CEUMA
* 2º referência secundária – sobre outro assunto que contém alguma parte sobre o CEUMA
* 3º referência terciária – sobre outro assunto correlato ao CEUMA
...
[CEUMA/USP]: http://www.usp.br/mariantonia/
